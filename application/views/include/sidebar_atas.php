      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="">
          ...
          <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
            ...
            <li>
              <a href="javascript:;">
                <span class="badge bg-green">@andreasdan</span>
              </a>
            </li>
            <li>
              <a href="javascript:;">
                <span class="badge bg-red">Customer Service</span>
              </a>
            </li>
            <li><a href="<?php echo base_url() ?>login/logout"><i class="fa fa-setting pull-right"></i> Setting</a>
            </li>
